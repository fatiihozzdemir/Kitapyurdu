...
public class OthersController extends HttpServlet {
	...
	private void editCategory(HttpServletRequest request, HttpServletResponse response)
		...
		if (categoryId != null) {
			...
			RequestDispatcher req = request.getRequestDispatcher("/WEB-INF/categoryEdit.jsp");
			req.forward(request, response);
		} else {
			doGet(request, response);
		}
	...
	private void editWriter(HttpServletRequest request, HttpServletResponse response)
		...
		if (writerId != null) {
			...
			RequestDispatcher req = request.getRequestDispatcher("/WEB-INF/writerEdit.jsp");
			req.forward(request, response);
		} else {
			doGet(request, response);
		}
	...
	private void addWriter(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
